...
extension MaintenanceComponentQueryWhere
  ...
  QueryBuilder<MaintenanceComponent, MaintenanceComponent, QAfterWhereClause>
      typeIndexBetween(
    String lowerTypeIndex,
    String upperTypeIndex, {
    bool includeLower = true,
    bool includeUpper = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<MaintenanceComponent, MaintenanceComponent, QAfterWhereClause>
      typeIndexStartsWith(String TypeIndexPrefix) {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(IndexWhereClause.between(
        indexName: r'typeIndex',
        lower: [TypeIndexPrefix],
        upper: ['$TypeIndexPrefix\u{FFFFF}'],
      ));
    });
  }
...
extension MaintenanceComponentQueryProperty on QueryBuilder<
  ...
  QueryBuilder<MaintenanceComponent, int, QQueryOperations> isarIdProperty() {
    return QueryBuilder.apply(this, (query) {
